...
/**
 * @brief Get the Lancs installation directory
 *
 * It is obtained from the /proc directory, argv[0], or the env variable LANCS_HOME
 *
 * @param arg ARGV0 - Program name
 * @return Pointer to the Lancs installation path on success
 */
