...
#define os_calloc(x,y,z) ((z = (__typeof__(z)) calloc(x,y)))?(void)1:lerror_exit(MEM_ERROR, errno, strerror(errno))

#define os_strdup(x,y) ((y = strdup(x)))?(void)1:lerror_exit(MEM_ERROR, errno, strerror(errno))

#define os_malloc(x,y) ((y = (__typeof__(y)) malloc(x)))?(void)1:lerror_exit(MEM_ERROR, errno, strerror(errno))

#define os_free(x) if(x){free(x);x=NULL;}

#define os_realloc(x,y,z) ((z = (__typeof__(z))realloc(x,y)))?(void)1:lerror_exit(MEM_ERROR, errno, strerror(errno))
