 ...
 * File:        pub_client.c 
 *
 * Description: Publish program for subscribe client MQTT in DLP connection module
 *
...
int main(int argc, char *argv[])
{
	...
	//cfg.message = strdup("Hello broker");
	//cfg.msglen = strlen("Hello broker");
	// cfg.pub_mode = MSGMODE_STDIN_FILE;
	// fprintf(stdin,"hello broker from stdin!\n");
	//cfg.pub_mode = MSGMODE_FILE;
	//cfg.file_input = strdup("/home/lancs/DataLossPrevention/codebase/LancsDLP/LancsDLP/logs/dlp.log");
